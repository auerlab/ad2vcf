...
_Bool skip_upstream_alignments(vcf_call_t *vcf_call, FILE *sam_stream, sam_buff_t *sam_buff, FILE *vcf_out_stream, ad2vcf_stats_t *);
_Bool allelic_depth(vcf_call_t *vcf_call, FILE *sam_stream, sam_buff_t *sam_buff, FILE *vcf_out_stream, ad2vcf_stats_t *);
_Bool call_in_alignment(vcf_call_t *vcf_call, sam_alignment_t *sam_alignment);
_Bool alignment_upstream_of_call(vcf_call_t *vcf_call, sam_alignment_t *sam_alignment);
void update_allele_count(vcf_call_t *vcf_call, sam_alignment_t *sam_alignment, FILE *vcf_out_stream, ad2vcf_stats_t *);
